...
Public Class ReportProjectname
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CRSWeb.ReportProjectname.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportProjectname
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportProjectname = New ReportProjectname()
        rpt.Site = Me.Site
        Return rpt
    End Function
