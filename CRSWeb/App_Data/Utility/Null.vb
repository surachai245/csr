...
Public Class Null
    ...
    Public Shared ReadOnly Property NullUInteger() As UInteger
        Get
            Return 0
        End Get
    End Property
    ...
    Public Shared ReadOnly Property NullTimespan() As TimeSpan
        Get
    ...
    Public Shared Function SetNull(ByVal objValue As Object, ByVal objField As Object) As Object
        If IsDBNull(objValue) Then
            ...
            ElseIf TypeOf objField Is Integer Then
                SetNull = NullInteger
            ElseIf TypeOf objField Is UInteger Then
                SetNull = NullUInteger
    ...
    Public Shared Function SetNullDateTime(ByVal objValue As Object) As DateTime
        ...
        If (Not IsDBNull(objValue)) AndAlso (Not IsNothing(objValue)) Then
            retValue = Convert.ToDateTime(objValue)
        End If
        Return retValue
    End Function

    Public Shared Function SetNullTimespan(ByVal objValue As Object) As TimeSpan
        Dim retValue As TimeSpan = Null.NullTimespan
        If Not IsDBNull(objValue) Then
            retValue = DirectCast(objValue, TimeSpan)
        End If
        Return retValue
    End Function
    ...
    Public Shared Function SetNullUInteger(ByVal objValue As Object) As UInteger
        Dim retValue As UInteger = Null.NullUInteger
        If Not IsDBNull(objValue) Then
            retValue = Convert.ToUInt32(objValue)
        End If
        Return retValue
    End Function

    Public Shared Function SetNullDecimal(ByVal objValue As Object) As Decimal
        Dim retValue As Decimal = 0
        If Not IsDBNull(objValue) Then
            retValue = Convert.ToDecimal(objValue)
        End If
        Return retValue
    End Function
    ...
    Public Shared Function GetNull(ByVal objField As Object, ByVal objDBNull As Object) As Object
        ...
        ElseIf TypeOf objField Is Integer Then
            ...
            End If
        ElseIf TypeOf objField Is UInteger Then
            If Convert.ToUInt32(objField) = NullUInteger Then
                GetNull = objDBNull
            End If
        ElseIf TypeOf objField Is Single Then
    ...
    Public Shared Function IsNull(ByVal objField As Object) As Boolean
        If Not objField Is Nothing Then
            ...
            ElseIf TypeOf objField Is UInteger Then
                IsNull = objField.Equals(NullUInteger)
            ElseIf TypeOf objField Is Short Then
